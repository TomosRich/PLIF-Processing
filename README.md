...
User input is required at several steps but only the initial time the code is run, if you want to reset the user input then go into your output folder and delete the scale_xy.m, and origin.m files.
...
Good luck, PLIF is a finnicky science :)